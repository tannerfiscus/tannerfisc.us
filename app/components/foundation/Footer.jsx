	...
	return (
		<footer>
			<div className='contain'>
				...
				<div className='logo logo-inverted'><div className='logo-shape'></div><div className='logo-text'>TF</div></div>
				...
				<div className='grid'>
					...
					<div className='grid-spread-3 padded'>
						...
						<a href='http://twitter.com/tannerfiscus'>Twitter</a> &middot; <a href='http://linkedin.com/in/tannerfiscus'>LinkedIn</a>
					</div>
